(function () {
    ...
    function normalizeCard(item) {
        ...
        return {
            ...
            overview:       item.overview || item.promo || '',
            ...
            genres_list:    item.genres_list    || [],
            countries_list: item.countries_list || [],
            persons_list:   item.persons_list   || [],
            slogan:         item.slogan         || '',
            vote_count_kp:  item.vote_count_kp  || 0,
            vote_count_imdb: item.vote_count_imdb || 0,
            networks_list:  item.networks_list  || [],
    ...
    function RutorApiService() {
        ...
        // ============================================================
        // FETCH RAW — обёртка над WORKER_URL
        // ============================================================
        ...
        self.category = function (params, onSuccess) {
            ...
            CATEGORIES.forEach(function (cat) {
                ...
                self._fetchRaw(url, function (data) {
                    ...
                    if (done === total) {
                        // Восстанавливаем порядок из CATEGORIES
        ...
        // ============================================================
        // LIST — постраничная загрузка одной категории
        // ============================================================
        ...
        // ============================================================
        // FULL — детальная информация о карточке
        // ============================================================
